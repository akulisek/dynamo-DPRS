...
json="{ \"ID\": \"$UUID\", \"Name\": \"$RAILS_NODE\", \"Address\": \"null\", \"Port\": 3000, \"check\": { \"http\": \"http://$IP:$PORT\", \"interval\": \"10s\", \"timeout\": \"2s\", \"deregisterService\": true, \"failuresTolerance\": 2}}"
echo $json
...
json="{ \"ID\": \"$UUID\", \"Name\": \"$RAILS_NODE\", \"Address\": \"$OVER_IP\", \"Port\": 3000, \"check\": { \"http\": \"http://$IP:$PORT\", \"interval\": \"10s\", \"timeout\": \"2s\", \"deregisterService\": true, \"failuresTolerance\": 2}}"
